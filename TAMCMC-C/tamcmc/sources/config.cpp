...
Config::Config(std::string current_path, std::string cfg_file_in, std::string cfg_file_errors, 
			   std::string cfg_models_ctrl_file_in, std::string cfg_priors_ctrl_file_in, std::string cfg_likelihoods_ctrl_file_in){ // The constructor

	VectorXi c_vals1, c_vals2, c_vals3;
	std::vector<std::string> str_vals1, str_vals2, str_vals3;
	...
	/*std::cout << "modeling.models:"  << std::endl;
	std::cout << modeling.models_case_list_ctrl << std::endl;
	std::cout << modeling.models_list_ctrl << std::endl;
	
	std::cout << "modeling.priors:" << std::endl;
	std::cout << modeling.priors_case_list_ctrl << std::endl;
	std::cout << modeling.priors_list_ctrl << std::endl;
	
	std::cout << "modeling.likelihoods:" << std::endl;
	std::cout << modeling.likelihoods_case_list_ctrl << std::endl;
	std::cout << modeling.likelihoods_list_ctrl << std::endl;
	*/
...
*/
	...
	for (i = 0; i< Npriors; i++){	
		...
		std::cout << modeling.priors_case_list_ctrl[i]  << "   " << modeling.priors_list_ctrl[i] << std::endl;
	}
	if (passed == 0){
